...
install_xcframework "${PODS_ROOT}/../PodBuilder/Prebuilt/SDWebImageSwiftUI/SDWebImageSwiftUI.xcframework" "SDWebImageSwiftUI" "framework" "ios-arm64_x86_64-simulator" "ios-arm64"
